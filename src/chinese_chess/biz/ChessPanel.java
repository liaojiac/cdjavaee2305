				...
				if(selectChess!=null) {
					//点棋子
					 if(currentChess==null) {//选子
						 if(isTurn == true&&selectChess.getCamp()==Camp.红方||isTurn == false&&selectChess.getCamp()==Camp.黑方) {
...
//构造函数的时候就初始化32个棋子
	...
	private void initChess() {
		...
		//两个炮
		Chess redGun1= new Gun(new Point(Constant.INITX+Constant.CHESS_SIZE*1,Constant.INITY+Constant.CHESS_SIZE*2), Camp.红方, Type.砲);
		Chess redGun2= new Gun(new Point(Constant.INITX+Constant.CHESS_SIZE*7,Constant.INITY+Constant.CHESS_SIZE*2), Camp.红方, Type.砲);
		//兵
		Chess redSoldier1= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*0,Constant.INITY+Constant.CHESS_SIZE*3), Camp.红方, Type.卒);
		Chess redSoldier2= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*2,Constant.INITY+Constant.CHESS_SIZE*3), Camp.红方, Type.卒);
		Chess redSoldier3= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*4,Constant.INITY+Constant.CHESS_SIZE*3), Camp.红方, Type.卒);
		Chess redSoldier4= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*6,Constant.INITY+Constant.CHESS_SIZE*3), Camp.红方, Type.卒);
		Chess redSoldier5= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*8,Constant.INITY+Constant.CHESS_SIZE*3), Camp.红方, Type.卒);
		...
		Chess blackHorse1= new Horse(new Point(Constant.INITX+Constant.CHESS_SIZE*1,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.马);
		Chess blackElephant1= new Elephant(new Point(Constant.INITX+Constant.CHESS_SIZE*2,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.象);
		Chess blackGuard1= new Guard(new Point(Constant.INITX+Constant.CHESS_SIZE*3,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.士);
		Chess blackBoss= new Boss(new Point(Constant.INITX+Constant.CHESS_SIZE*4,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.将);
		Chess blackGuard2= new Guard(new Point(Constant.INITX+Constant.CHESS_SIZE*5,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.士);
		Chess blackElephant2= new Elephant(new Point(Constant.INITX+Constant.CHESS_SIZE*6,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.象);
		Chess blackHorse2= new Horse(new Point(Constant.INITX+Constant.CHESS_SIZE*7,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.马);
		Chess blackCar2= new Car(new Point(Constant.INITX+Constant.CHESS_SIZE*8,Constant.INITY+Constant.CHESS_SIZE*9), Camp.黑方, Type.车);
		//两个炮
		Chess blackGun1= new Gun(new Point(Constant.INITX+Constant.CHESS_SIZE*1,Constant.INITY+Constant.CHESS_SIZE*7), Camp.黑方, Type.砲);
		Chess blackGun2= new Gun(new Point(Constant.INITX+Constant.CHESS_SIZE*7,Constant.INITY+Constant.CHESS_SIZE*7), Camp.黑方, Type.砲);
		//兵
		Chess blackSoldier1= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*0,Constant.INITY+Constant.CHESS_SIZE*6), Camp.黑方, Type.卒);
		Chess blackSoldier2= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*2,Constant.INITY+Constant.CHESS_SIZE*6), Camp.黑方, Type.卒);
		Chess blackSoldier3= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*4,Constant.INITY+Constant.CHESS_SIZE*6), Camp.黑方, Type.卒);
		Chess blackSoldier4= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*6,Constant.INITY+Constant.CHESS_SIZE*6), Camp.黑方, Type.卒);
		Chess blackSoldier5= new Soldier(new Point(Constant.INITX+Constant.CHESS_SIZE*8,Constant.INITY+Constant.CHESS_SIZE*6), Camp.黑方, Type.卒);
